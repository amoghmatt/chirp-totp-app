...
- (void)viewDidLoad {
    ...
    self.secretTextField.text = TOTP_APP_KEY;
    ...
    self.connect = [[ChirpConnect alloc] initWithAppKey:TOTP_APP_KEY andSecret:TOTP_APP_SECRET];
    [self.connect setLicenceString:TOTP_LICENCE];
    [self.connect start];
}
